...
The sync engine: layered manifests, journal union-merge, LWW+conflict copies, end-to-end encryption, offline-first resumability, and serverless concurrent-writer convergence.
